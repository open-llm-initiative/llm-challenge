...
class PromptDBHandler():
    def __init__(self, prod=False):
        ...
        #load the challenge prompts in memory to serve them quickly
        self.load_challenge_responses_from_file()
 
    def load_challenge_responses_from_file(self):
    ...
    def get_sample_prompt(self, prompt_id):
        try:
    ...
    @staticmethod
    def store_challenge_response(session_id, prompt_id, rating, timestamp=None, prod=False):
        ...
        try:
            table_name = challenge_responses_table_name if prod else challenge_responses_table_name_test
            table = self.dynamodb.Table(table_name)
